...
export class Migration1745082131936 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."fraud-history_reason_enum" AS ENUM('0', '1', '2')`);
        await queryRunner.query(`CREATE TABLE "fraud-history" ("id" SERIAL NOT NULL, "reason" "public"."fraud-history_reason_enum" NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "invoiceId" integer, CONSTRAINT "PK_a8c118c9dedd46821f05e10cd03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "fraud-history" ADD CONSTRAINT "FK_32c2d94f6dbfe77cff2579a24ff" FOREIGN KEY ("invoiceId") REFERENCES "invoices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "fraud-history" DROP CONSTRAINT "FK_32c2d94f6dbfe77cff2579a24ff"`);
